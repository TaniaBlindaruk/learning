...
class ISM_News_Adminhtml_NewsController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->loadLayout()->_setActiveMenu('ismnews');
        $this->_addContent($this->getLayout()->createBlock('ismnews/adminhtml_news'));
        $this->renderLayout();
    }
    ...
    public function editAction()
    {
        ...
        Mage::register('current_news', Mage::getModel('ismnews/news')->load($id));

        $this->loadLayout()->_setActiveMenu('ismnews');
        $this->_addContent($this->getLayout()->createBlock('ismnews/adminhtml_news_edit'));
        $this->renderLayout();
    }
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            try {
                $model = Mage::getModel('ismnews/news');
    ...
    public function deleteAction()
    {
        if ($id = $this->getRequest()->getParam('id')) {
            try {
                Mage::getModel('ismnews/news')->setId($id)->delete();
